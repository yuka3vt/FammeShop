    ...
    <div class="col-md-12">
        <form action="/admin/blog-edit/{{ $blog->slug }}" method="POST" enctype="multipart/form-data"> 
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="judul" class="form-control" id="nama" placeholder="Judul blog" autofocus required value="{{ $blog->judul }}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="Slug" class="form-control" id="slug" readonly value="{{ $blog->slug }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control konten" id="konten" name="isi_blog" rows="6">{!! $blog->isi_blog !!}</textarea>
            </div>
