...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="/admin/produk-kategori-edit/{{ $produkKategori->slug }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $produkKategori->slug }}" type="text" class="form-control" name="slug" id="slug" placeholder="Slug Kategori" readonly required>
                    </div>
